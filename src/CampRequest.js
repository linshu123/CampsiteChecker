...
import type {Campsite} from './CampSiteFactory';

function sendRequest(arrivalDate : Date, stayLength : number, campsite : Campsite) {
  var headers = {
...
function callback(error: string, response: string, body: string) {
